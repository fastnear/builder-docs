...
These shell examples run against the RPC and Transactions endpoints; the FastNear calls send `FASTNEAR_API_KEY` from your shell as a bearer header, so set it first.
