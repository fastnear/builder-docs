...
These shell steps run against the SocialDB and FastNear endpoints; the FastNear calls send `FASTNEAR_API_KEY` from your shell as a bearer header, so set it first.
