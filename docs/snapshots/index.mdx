...
Use [Snapshot Examples](/snapshots/examples) for operator-oriented flows like choosing between optimized `fast-rpc`, standard RPC recovery, and archival hot/cold snapshot paths.
