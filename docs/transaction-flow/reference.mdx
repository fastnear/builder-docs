...
These RPC reads work on the public FastNear RPC hosts. If `FASTNEAR_API_KEY` is already set in your shell, the snippets forward it automatically as a bearer header.
