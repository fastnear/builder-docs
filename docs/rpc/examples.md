...
slug: /rpc/examples
title: RPC Examples
description: Plain-language workflows for using FastNear RPC docs for transaction submission, access-key checks, FT preflight, raw-state reads, and Rainbow Bridge discovery.
