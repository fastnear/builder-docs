...
slug: /api/reference
title: API Reference
description: Overview of the FastNear REST API families and how they differ from direct JSON-RPC methods.
...
- [FastNear API](/api) for indexed account, token, NFT, and public-key lookups.
