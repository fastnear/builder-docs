...
Получите набор валидаторов выбранной прошлой эпохи по высоте начального блока или хеш-идентификатору эпохи в кодировке Base58.
## Ссылки на источник
...
- Путь: `/`
## OpenAPI
- Эта операция: https://docs.fastnear.com/openapi/rpc/validators_by_epoch.json (https://docs.fastnear.com/openapi/rpc/validators_by_epoch.yaml)
- Полный документ API: https://docs.fastnear.com/openapi/rpc.json
- Указатель в полном документе: https://docs.fastnear.com/openapi/rpc.json#/paths/~1validators_by_epoch/post
## Сети
- Mainnet: https://archival-rpc.mainnet.fastnear.com/ (archival: Pinned epoch, older than standard RPC retention.)
- Testnet: https://archival-rpc.testnet.fastnear.com/ (archival: Pinned epoch, older than standard RPC retention.)
## Авторизация
