...
- Путь: `/`
## OpenAPI
- Эта операция: https://docs.fastnear.com/openapi/rpc/EXPERIMENTAL_protocol_config.json (https://docs.fastnear.com/openapi/rpc/EXPERIMENTAL_protocol_config.yaml)
- Полный документ API: https://docs.fastnear.com/openapi/rpc.json
- Указатель в полном документе: https://docs.fastnear.com/openapi/rpc.json#/paths/~1EXPERIMENTAL_protocol_config/post
## Сети
