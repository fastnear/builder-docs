...
Получите Merkle-доказательство — по хешам блока и вершины лайт-клиента в кодировке Base58 — того, что блок включён в верифицированную цепочку лайт-клиента.
## Ссылки на источник
...
- Путь: `/`
## OpenAPI
- Эта операция: https://docs.fastnear.com/openapi/rpc/EXPERIMENTAL_light_client_block_proof.json (https://docs.fastnear.com/openapi/rpc/EXPERIMENTAL_light_client_block_proof.yaml)
- Полный документ API: https://docs.fastnear.com/openapi/rpc.json
- Указатель в полном документе: https://docs.fastnear.com/openapi/rpc.json#/paths/~1EXPERIMENTAL_light_client_block_proof/post
## Сети
- Mainnet: https://archival-rpc.mainnet.fastnear.com/ (archival: Pinned block, older than standard RPC retention.)
- Testnet: https://archival-rpc.testnet.fastnear.com/ (archival: Pinned block, older than standard RPC retention.)
## Авторизация
