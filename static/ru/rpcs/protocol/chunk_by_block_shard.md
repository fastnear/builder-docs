...
- Путь: `/`
## OpenAPI
- Эта операция: https://docs.fastnear.com/openapi/rpc/chunk_by_block_shard.json (https://docs.fastnear.com/openapi/rpc/chunk_by_block_shard.yaml)
- Полный документ API: https://docs.fastnear.com/openapi/rpc.json
- Указатель в полном документе: https://docs.fastnear.com/openapi/rpc.json#/paths/~1chunk_by_block_shard/post
## Сети
- Mainnet: https://archival-rpc.mainnet.fastnear.com/ (archival: Pinned parent block, older than standard RPC retention.)
- Testnet: https://archival-rpc.testnet.fastnear.com/ (archival: Pinned parent block, older than standard RPC retention.)
## Авторизация
