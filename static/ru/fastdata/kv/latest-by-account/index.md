...
## OpenAPI
- Эта операция: https://docs.fastnear.com/openapi/kv-fastdata/latest_by_account.json (https://docs.fastnear.com/openapi/kv-fastdata/latest_by_account.yaml)
- Полный документ API: https://docs.fastnear.com/openapi/kv-fastdata.json
- Указатель в полном документе: https://docs.fastnear.com/openapi/kv-fastdata.json#/paths/~1v0~1latest~1%7Bcurrent_account_id%7D/post
## Сети
