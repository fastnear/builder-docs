...
Получите каждую историческую запись для одного точного ключа под одним вызывающим аккаунтом и контрактом.
## Ссылки на источник
- https://docs.fastnear.com/ru/fastdata/kv/get-history-key
