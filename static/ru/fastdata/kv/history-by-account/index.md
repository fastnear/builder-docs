...
## Ссылки на источник
- https://docs.fastnear.com/ru/fastdata/kv/history-by-account
...
## OpenAPI
- Эта операция: https://docs.fastnear.com/openapi/kv-fastdata/history_by_account.json (https://docs.fastnear.com/openapi/kv-fastdata/history_by_account.yaml)
- Полный документ API: https://docs.fastnear.com/openapi/kv-fastdata.json
- Указатель в полном документе: https://docs.fastnear.com/openapi/kv-fastdata.json#/paths/~1v0~1history~1%7Bcurrent_account_id%7D/post
## Сети
