...
Перенаправление на самый свежий оптимистичный блок — максимально свежая вершина, до финализации.
## Ссылки на источник
- https://docs.fastnear.com/ru/neardata/last-block-optimistic
...
## OpenAPI
- Эта операция: https://docs.fastnear.com/openapi/neardata/get_last_block_optimistic.json (https://docs.fastnear.com/openapi/neardata/get_last_block_optimistic.yaml)
- Полный документ API: https://docs.fastnear.com/openapi/neardata.json
- Указатель в полном документе: https://docs.fastnear.com/openapi/neardata.json#/paths/~1v0~1last_block~1optimistic/get
## Сети
