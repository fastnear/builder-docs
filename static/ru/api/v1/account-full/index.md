...
## OpenAPI
- Эта операция: https://docs.fastnear.com/openapi/fastnear/account_full_v1.json (https://docs.fastnear.com/openapi/fastnear/account_full_v1.yaml)
- Полный документ API: https://docs.fastnear.com/openapi/fastnear.json
- Указатель в полном документе: https://docs.fastnear.com/openapi/fastnear.json#/paths/~1v1~1account~1%7Baccount_id%7D~1full/get
## Сети
