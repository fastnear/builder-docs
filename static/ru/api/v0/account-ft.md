...
Получите ID FT-контрактов, которых касался аккаунт — только ID, без балансов.
## Ссылки на источник
- https://docs.fastnear.com/ru/api/v0/account-ft
...
## OpenAPI
- Эта операция: https://docs.fastnear.com/openapi/fastnear/account_ft_v0.json (https://docs.fastnear.com/openapi/fastnear/account_ft_v0.yaml)
- Полный документ API: https://docs.fastnear.com/openapi/fastnear.json
- Указатель в полном документе: https://docs.fastnear.com/openapi/fastnear.json#/paths/~1v0~1account~1%7Baccount_id%7D~1ft/get
## Сети
