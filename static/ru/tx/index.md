...
- Если ваша интеграция стандартизирует один FastNear API-ключ на всех поверхностях FastNear, используйте здесь тот же формат через заголовок или query-параметр.
