...
{/* FASTNEAR_AI_DISCOVERY: Этот case study показывает краткий и полезный путь для Berry Club: сначала прочитайте живую доску через RPC get_lines, а Transactions API используйте только тогда, когда нужно восстановить одну более раннюю эпоху по draw-вызовам. */}

# Berry Club Case Study: как читать живую доску и разбирать одну эпоху

Используйте этот case study, когда живую доску читать легко, но нужен один понятный путь к исторической реконструкции.
