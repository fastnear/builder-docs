...
Эти shell-примеры выполняются на RPC и Transactions endpoint-ах; FastNear-вызовы передают `FASTNEAR_API_KEY` из окружения как bearer-заголовок, поэтому сначала задайте её.
