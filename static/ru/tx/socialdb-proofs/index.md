...
Эти shell-шаги выполняются на endpoint-ах SocialDB и FastNear; FastNear-вызовы передают `FASTNEAR_API_KEY` из окружения как bearer-заголовок, поэтому сначала задайте её.
