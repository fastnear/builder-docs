...
Используйте [примеры RPC](https://docs.fastnear.com/ru/rpc/examples) для простых пошаговых сценариев: точных проверок состояния, анализа блоков, view-вызовов контрактов и отправки транзакций с подтверждением.
