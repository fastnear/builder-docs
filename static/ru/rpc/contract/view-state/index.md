...
## Ссылки на источник
- https://docs.fastnear.com/ru/rpc/contract/view-state
...
- Путь: `/`
## OpenAPI
- Эта операция: https://docs.fastnear.com/openapi/rpc/view_state.json (https://docs.fastnear.com/openapi/rpc/view_state.yaml)
- Полный документ API: https://docs.fastnear.com/openapi/rpc.json
- Указатель в полном документе: https://docs.fastnear.com/openapi/rpc.json#/paths/~1view_state/post
## Сети
