...
## Ссылки на источник
- https://docs.fastnear.com/ru/rpc/protocol/experimental-light-client-proof
...
- https://docs.fastnear.com/ru/reference/operation/EXPERIMENTAL_light_client_proof
## Операция
- Транспорт: json-rpc
- Метод: POST
- Путь: `/`
## OpenAPI
- Эта операция: https://docs.fastnear.com/openapi/rpc/EXPERIMENTAL_light_client_proof.json (https://docs.fastnear.com/openapi/rpc/EXPERIMENTAL_light_client_proof.yaml)
- Полный документ API: https://docs.fastnear.com/openapi/rpc.json
- Указатель в полном документе: https://docs.fastnear.com/openapi/rpc.json#/paths/~1EXPERIMENTAL_light_client_proof/post
## Сети
