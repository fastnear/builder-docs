...
## Ссылки на источник
- https://docs.fastnear.com/ru/rpc/protocol/metrics
...
- Путь: `/metrics`
## OpenAPI
- Эта операция: https://docs.fastnear.com/openapi/rpc/metrics.json (https://docs.fastnear.com/openapi/rpc/metrics.yaml)
- Полный документ API: https://docs.fastnear.com/openapi/rpc.json
- Указатель в полном документе: https://docs.fastnear.com/openapi/rpc.json#/paths/~1metrics/get
## Сети
