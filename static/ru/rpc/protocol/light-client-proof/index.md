...
Получите Merkle-доказательство — по ID транзакции или квитанции в кодировке Base58 — того, что элемент был включён и исполнен, для верификации лайт-клиентом.
## Ссылки на источник
- https://docs.fastnear.com/ru/rpc/protocol/light-client-proof
