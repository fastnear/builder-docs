...
- Путь: `/`
## OpenAPI
- Эта операция: https://docs.fastnear.com/openapi/rpc/gas_price_by_block.json (https://docs.fastnear.com/openapi/rpc/gas_price_by_block.yaml)
- Полный документ API: https://docs.fastnear.com/openapi/rpc.json
- Указатель в полном документе: https://docs.fastnear.com/openapi/rpc.json#/paths/~1gas_price_by_block/post
## Сети
