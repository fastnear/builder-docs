...
## Ссылки на источник
- https://docs.fastnear.com/ru/rpc/protocol/status
...
- Путь: `/`
## OpenAPI
- Эта операция: https://docs.fastnear.com/openapi/rpc/status.json (https://docs.fastnear.com/openapi/rpc/status.yaml)
- Полный документ API: https://docs.fastnear.com/openapi/rpc.json
- Указатель в полном документе: https://docs.fastnear.com/openapi/rpc.json#/paths/~1status/post
## Сети
