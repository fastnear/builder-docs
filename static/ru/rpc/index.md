...
OpenAPI: [JSON](https://docs.fastnear.com/ru/openapi/rpc.json) · [YAML](https://docs.fastnear.com/ru/openapi/rpc.yaml) · [все спецификации](https://docs.fastnear.com/ru/openapi)
...
- Передавайте API-ключ FastNear и на обычных, и на архивных RPC-хостах — либо в заголовке `Authorization: Bearer`, либо в URL-параметре `?apiKey=`; см. [Аутентификацию и доступ](https://docs.fastnear.com/ru/auth).
