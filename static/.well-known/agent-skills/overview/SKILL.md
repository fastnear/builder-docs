...
- Need to expose FastNear to Claude Desktop, Codex, Cursor, or another MCP client? Use [Building an MCP Server with FastNear](https://docs.fastnear.com/agents/mcp).
...
- Need to build your own MCP tool surface on top of FastNear? [Building an MCP Server with FastNear](https://docs.fastnear.com/agents/mcp)
