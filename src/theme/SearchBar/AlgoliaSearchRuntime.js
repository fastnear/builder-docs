...
function DocSearch({ externalUrlRegex, openRequestId = 0, ...props }) {
  ...
  useEffect(() => {
    if (!openRequestId || openRequestId === lastOpenRequestId.current) {
      return;
    }
...
export default function AlgoliaSearchRuntime(props) {
