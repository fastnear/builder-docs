...
Используйте [Transfers API Examples](/transfers/examples) для простых пошаговых сценариев: узкие поиски переводов, пагинация через `resume_token` и переход к более широкому расследованию транзакций.
