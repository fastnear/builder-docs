...
- Передавайте API-ключ FastNear и на обычных, и на архивных RPC-хостах — либо в заголовке `Authorization: Bearer`, либо в URL-параметре `?apiKey=`; см. [Аутентификацию и доступ](/auth).
