...
- Заканчиваете простым handoff: если следующий вопрос уже звучит как «какая транзакция записала этот виджет?», переходите к сценариям-доказательствам в [Transactions Examples](/tx/examples).
...
Если следующий вопрос уже меняется на «какая транзакция записала именно эту версию виджета?», сохраните эту высоту блока и переходите к сценариям-доказательствам NEAR Social в [Transactions Examples](/tx/examples).
