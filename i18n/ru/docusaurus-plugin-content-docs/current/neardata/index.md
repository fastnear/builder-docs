...
Используйте [примеры NEAR Data API](/neardata/examples) для простых пошаговых сценариев: опроса оптимистичных блоков, подтверждения финализированных блоков, работы с перенаправлениями и перехода к каноническому RPC.
