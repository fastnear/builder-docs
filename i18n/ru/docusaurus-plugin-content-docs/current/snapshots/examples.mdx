...
- [Снапшоты mainnet](/snapshots/mainnet), если нужно дополнительно настроить `THREADS`, `BWLIMIT` или кастомный `DATA_PATH`.
...
- [Снапшоты mainnet](/snapshots/mainnet), если нужно дополнительно настроить `DATA_PATH`, `THREADS` или ограничения по пропускной способности.
