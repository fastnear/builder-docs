...
Требования к узлам смотрите в <Link to="https://github.com/near/nearcore?tab=readme-ov-file#about-near">nearcore</Link>, а исходники скриптов загрузки, которые используются в этих руководствах, — в <Link to="https://github.com/fastnear/static">fastnear/static</Link>.

## Нужен сценарий?

Используйте [примеры снапшотов](/snapshots/examples) для операторских сценариев: выбора между оптимизированным `fast-rpc`, стандартным восстановлением RPC и архивными путями с разделением горячих и холодных данных.
