---
sidebar_label: Berry Club Case Study
slug: /tx/examples/berry-club
title: "Berry Club Case Study: как читать живую доску и разбирать одну эпоху"
description: "Case study, который начинается с живой доски Berry Club через RPC get_lines, а затем использует Transactions API, чтобы восстановить одну более раннюю эпоху."
