...
description: "Индексированные запросы по транзакциям, квитанциям, истории аккаунтов и истории блоков для FastNear."
sidebar_position: 1
...
- Используйте [FastNear API](/api), когда нужны балансы, NFT, стейкинг или поиск по публичному ключу.
- Используйте [Справочник RPC](/rpc), когда нужно каноническое поведение узла или отправка транзакций.
...
- [Транзакции по хешу](/tx/transactions) — когда вы уже знаете идентификатор транзакции.
- [История аккаунта](/tx/account) — для лент активности и отладки аккаунта.
- [Поиск квитанции](/tx/receipt) — для расследования цепочки исполнения.
- [Диапазон блоков](/tx/blocks) — когда нужен ограниченный по диапазону просмотр истории.

## Нужен сценарий?

Используйте [Transactions API Examples](/tx/examples) для простых пошаговых сценариев: поиск транзакций, расследование квитанций, история аккаунта и анализ диапазонов блоков.
