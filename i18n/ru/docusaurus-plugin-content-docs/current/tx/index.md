...
- Используйте [FastNear API](/api), когда вам нужны балансы, NFT, стейкинг или поиск по публичному ключу.
- Используйте [Справочник RPC](/rpc), когда вам нужно каноническое поведение узла или отправка транзакций.
