...
Используйте [примеры API транзакций](/tx/examples) для простых пошаговых сценариев: поиска транзакций, расследования квитанций, истории аккаунта и анализа диапазонов блоков.
